...
$intern = query("SELECT * FROM tbl_artikel LIMIT $dataawal, $jumlahdataitem");
        ...
        <div class="navbar">
            <div class="navbar_container">
                <ul>
                    ...
                    <li>
                        <a class="nav_item" href="#">Article</a>
                    </li>
                </ul>
        ...
        <div class="home_page">
            <div class="home_container">
                <div class="header">
                        ...
                        <table border="2" cellpadding="5" cellspacing="0">
                            ...
                            <?php foreach ($intern as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../img_article/<?= $row["gambar"]; ?>"
                    ...
                    <?php endif; ?>
                    <div class="footer">
                        <a class="btn_tool" href="./articleAksi.php">INPUT</a>
                    </div>
                </div>
            </div>
        </div>
