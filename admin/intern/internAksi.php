    ...
    <div class="wrapper">
        ...
        <form action="" method="post">
            <div class="form_input">
                ...
                <div class="section">
                    <ul>
                        <li><input type="text" id="institusi" name="institusi"></input></li>
                        <li><input type="text" id="linkwebsite" name="linkwebsite"></input></li>
                        <li><input type="text" id="sektor" name="sektor"></input></li>
                        <li><input type="text" id="posisi" name="posisi"></input></li>
                        <li><input type="text" id="alamat" name="alamat"></input></li>
                        <li><input type="text" id="durasi" name="durasi"></input></li>
                        <li><input type="text" id="isi" name="isi"></input></li>
                        <li><input type="text" id="informasi" name="informasi"></input></li>
                        <li><input type="text" id="logo" name="logo"></input></li>
                    </ul>
